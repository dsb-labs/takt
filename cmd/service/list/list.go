...
// Command returns the "service list" command used to list the services the orca
// server holds.
func Command() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: "List services.\n\n" +
			...
			"hold:\n\n" +
			"  orca service list --query '$.labels.app=web'\n" +
			"  orca service list -q '$.labels.app=web' -q '$.labels.env=prod'",
		Args: cobra.NoArgs,
