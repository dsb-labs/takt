...
// NewMockNodeService creates a new instance of MockNodeService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockNodeService(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockNodeService {
...
// MockNodeService is an autogenerated mock type for the NodeService type
type MockNodeService struct {
	mock.Mock
}

type MockNodeService_Expecter struct {
	mock *mock.Mock
}

func (_m *MockNodeService) EXPECT() *MockNodeService_Expecter {
	return &MockNodeService_Expecter{mock: &_m.Mock}
}
...
// MockNodeService_Get_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Get'
type MockNodeService_Get_Call struct {
	*mock.Call
}
...
func (_c *MockNodeService_Get_Call) Return(node service.Node, err error) *MockNodeService_Get_Call {
...
// MockWorkloadService_Events_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Events'
type MockWorkloadService_Events_Call struct {
	*mock.Call
}
...
func (_c *MockWorkloadService_Events_Call) Return(events []service.Event, err error) *MockWorkloadService_Events_Call {
