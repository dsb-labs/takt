CREATE TABLE workload_port_new (
    ...
    PRIMARY KEY (workload_id, instance, container_port, protocol),
    UNIQUE (host_port, protocol)
);

INSERT INTO workload_port_new (workload_id, instance, container_port, host_port, protocol, is_dynamic)
SELECT workload_id, 0, container_port, host_port, 'tcp', is_dynamic
FROM workload_port;
