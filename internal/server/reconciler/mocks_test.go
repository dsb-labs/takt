...
// RevokeForInstance provides a mock function for the type MockTokens
func (_mock *MockTokens) RevokeForInstance(ctx context.Context, workloadID string, instance int) error {
	ret := _mock.Called(ctx, workloadID, instance)

	if len(ret) == 0 {
		panic("no return value specified for RevokeForInstance")
	}
...
// MockTokens_RevokeForInstance_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RevokeForInstance'
type MockTokens_RevokeForInstance_Call struct {
	*mock.Call
}

// RevokeForInstance is a helper method to define mock.On call
//   - ctx context.Context
//   - workloadID string
//   - instance int
func (_e *MockTokens_Expecter) RevokeForInstance(ctx any, workloadID any, instance any) *MockTokens_RevokeForInstance_Call {
	return &MockTokens_RevokeForInstance_Call{Call: _e.mock.On("RevokeForInstance", ctx, workloadID, instance)}
}

func (_c *MockTokens_RevokeForInstance_Call) Run(run func(ctx context.Context, workloadID string, instance int)) *MockTokens_RevokeForInstance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockTokens_RevokeForInstance_Call) Return(err error) *MockTokens_RevokeForInstance_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockTokens_RevokeForInstance_Call) RunAndReturn(run func(ctx context.Context, workloadID string, instance int) error) *MockTokens_RevokeForInstance_Call {
	_c.Call.Return(run)
	return _c
}

// RevokeForWorkload provides a mock function for the type MockTokens
func (_mock *MockTokens) RevokeForWorkload(ctx context.Context, workloadID string) error {
	ret := _mock.Called(ctx, workloadID)

	if len(ret) == 0 {
		panic("no return value specified for RevokeForWorkload")
	}
...
// MockTokens_RevokeForWorkload_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RevokeForWorkload'
type MockTokens_RevokeForWorkload_Call struct {
	*mock.Call
}

// RevokeForWorkload is a helper method to define mock.On call
//   - ctx context.Context
//   - workloadID string
func (_e *MockTokens_Expecter) RevokeForWorkload(ctx any, workloadID any) *MockTokens_RevokeForWorkload_Call {
	return &MockTokens_RevokeForWorkload_Call{Call: _e.mock.On("RevokeForWorkload", ctx, workloadID)}
}

func (_c *MockTokens_RevokeForWorkload_Call) Run(run func(ctx context.Context, workloadID string)) *MockTokens_RevokeForWorkload_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockTokens_RevokeForWorkload_Call) Return(err error) *MockTokens_RevokeForWorkload_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockTokens_RevokeForWorkload_Call) RunAndReturn(run func(ctx context.Context, workloadID string) error) *MockTokens_RevokeForWorkload_Call {
	_c.Call.Return(run)
	return _c
}

// RevokeSuperseded provides a mock function for the type MockTokens
func (_mock *MockTokens) RevokeSuperseded(ctx context.Context, workloadID string, version int) error {
	ret := _mock.Called(ctx, workloadID, version)

	if len(ret) == 0 {
		panic("no return value specified for RevokeSuperseded")
	}
...
// MockTokens_RevokeSuperseded_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RevokeSuperseded'
type MockTokens_RevokeSuperseded_Call struct {
	*mock.Call
}

// RevokeSuperseded is a helper method to define mock.On call
//   - ctx context.Context
//   - workloadID string
//   - version int
func (_e *MockTokens_Expecter) RevokeSuperseded(ctx any, workloadID any, version any) *MockTokens_RevokeSuperseded_Call {
	return &MockTokens_RevokeSuperseded_Call{Call: _e.mock.On("RevokeSuperseded", ctx, workloadID, version)}
}

func (_c *MockTokens_RevokeSuperseded_Call) Run(run func(ctx context.Context, workloadID string, version int)) *MockTokens_RevokeSuperseded_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockTokens_RevokeSuperseded_Call) Return(err error) *MockTokens_RevokeSuperseded_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockTokens_RevokeSuperseded_Call) RunAndReturn(run func(ctx context.Context, workloadID string, version int) error) *MockTokens_RevokeSuperseded_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockRecorder) Record(ctx context.Context, workload string, reason event.Reason, data []byte) error {
	ret := _mock.Called(ctx, workload, reason, data)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, event.Reason, []byte) error); ok {
		r0 = returnFunc(ctx, workload, reason, data)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
//   - reason event.Reason
//   - data []byte
func (_e *MockRecorder_Expecter) Record(ctx any, workload any, reason any, data any) *MockRecorder_Record_Call {
	return &MockRecorder_Record_Call{Call: _e.mock.On("Record", ctx, workload, reason, data)}
}

func (_c *MockRecorder_Record_Call) Run(run func(ctx context.Context, workload string, reason event.Reason, data []byte)) *MockRecorder_Record_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRecorder_Record_Call) RunAndReturn(run func(ctx context.Context, workload string, reason event.Reason, data []byte) error) *MockRecorder_Record_Call {
	_c.Call.Return(run)
	return _c
}
